...
if ($search_refer == 'bonplan') { load_template(TEMPLATEPATH . '/template_search_bonplan.php'); }
elseif ($search_refer == 'video') { load_template(TEMPLATEPATH . '/template_search_video.php'); }
elseif ($search_refer == 'photo') { load_template(TEMPLATEPATH . '/template_search_photo.php'); }
;?>
