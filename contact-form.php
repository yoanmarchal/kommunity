...
<?php } else { ?>
	...
	<?php while (have_posts()) : the_post(); ?>
		...
		<form action="<?php the_permalink(); ?>" id="contactForm" method="post">
			...
			<fieldset>
				<input class="v-middle"  type="checkbox" name="sendCopy" id="sendCopy" value="true"<?php if(isset($_POST['sendCopy']) && $_POST['sendCopy'] == true) echo ' checked="checked"'; ?> />
