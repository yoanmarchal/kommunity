...
(function($) {
    ...
    $.fn.imgPreview = function(options) {
        ...
        var settings = $.extend({
            ...
            label_text:"Selectionner un fichier image",
            warning_message:"Ce n'est pas une image.",
