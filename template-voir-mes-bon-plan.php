...
<?php if ( is_user_logged_in() ) { ?>
	...
	<nav class="form col-md-4" >
		
		<div class="add-top" data-spy="affix" data-offset-top="60" data-offset-bottom="200">
			<a id="open-bp-form" class="btn" href="#"><i class="fui-plus-16"></i> Ajouter un bon plan</a>
			<ul class="list-unstyled row">
	          <li class="col-md-12 add-top">
	            <label class="share-label" for="showhoraire"><i class="fui-time-16"></i></label>
	           	<input type="checkbox" class="js-switch" id="showhoraire" />
	          </li>
	          <li class="col-md-12 add-top">
	            <label class="share-label" for="showadress">Adresse</label>
	...
	<div id="primary-form-bp" class="col-md-8">
		<form action="<?php echo add_query_arg('do', 'add_bonplan'); ?>" id="primaryPostForm" method="POST" role="form" enctype="multipart/form-data">
			...
			<fieldset class="form-group">
				...
				<button type="submit" class="btn btn-large"><i class="fui-checkmark-16"></i> Envoyer</button>
			</fieldset>
