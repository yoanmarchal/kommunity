...
<?php if (is_user_logged_in()) {
	...
	<div class="row">
		...
		<div id="primary-form-bp" class="col-md-9 col-xs-12">
			<form action="<?php echo add_query_arg('do', 'add_bonplan');
    ?>" id="primaryPostForm" method="POST" role="form" enctype="multipart/form-data">
				<fieldset class="form-group">
					<label for="postTitle">Titre</label>
					<input type="text" name="postTitle" id="postTitle" value="<?php if (isset($_POST['postTitle'])) {
    echo $_POST['postTitle'];
}
    ?>" class="form-control required" placeholder="Titre"/>
				</fieldset>
    ...
    ?>
				...
				<div id="localisation-box">
					...
					<fieldset class="form-group">
						...
						<input type="text" name="rue" id="rue" placeholder="Entrez ici nom et numéro de rue " value="<?php if (isset($_POST['rue'])) {
    echo $_POST['rue'];
}
    ?>" class="form-control" />
					</fieldset>
					...
					<fieldset class="form-group">
						...
						<input type="number" step="1"  name="postal-code" id="postal-code" placeholder="87000" value="<?php if (isset($_POST['postal-code'])) {
    ...
    ?>" class="form-control"/>
					...
					<fieldset class="form-group">
						...
						<input type="text" name="ville" id="ville" placeholder="Entrez ici le nom de la ville" value="<?php if (isset($_POST['ville'])) {
    echo $_POST['ville'];
}
    ?>" class="form-control" />
					</fieldset>
				...
				<div id="horaire-box">
					<div class="row">
						...
						<fieldset class="form-group col-md-6">
							...
							<input type="date" name="startDate" id="startDate" class="date form-control" value="<?php if (isset($_POST['startDate'])) {
    ...
    ?>" />
						...
						<fieldset class="form-group col-md-6">
							...
							<input type="time" name="startHour" id="startHour" placeholder="12:00" value="<?php if (isset($_POST['startHour'])) {
    ...
    ?>" class="form-control" />
						...
						<fieldset class="form-group col-md-6">
							...
							<input type="date" name="endDate" id="endDate" class="date form-control" value="<?php if (isset($_POST['endDate'])) {
    echo $_POST['endDate'];
}
    ?>" />
						</fieldset>
						...
						<fieldset class="form-group col-md-6">
							...
							<input type="time" name="endHour" id="endHour" class="form-control" placeholder="12:00" value="<?php if (isset($_POST['endHour'])) {
    echo $_POST['endHour'];
}
    ?>" />
						</fieldset>
