				  ...
				  <!-- Collect the nav links, forms, and other content for toggling -->
				    ...
				    <div class="btn-group btn-group-lg ">
                        ...
                        if (is_user_logged_in()) {
                            //logged in
                        ?>						
						<a class="btn  btn-primary" href="<?php echo get_author_posts_url($current_user->ID);
                            ?>" title="Voir mon profil" data-placement="bottom">
						...
						<a class="btn  btn-primary" href="<?php echo home_url();
                            ?>/mes-bons-plans" data-toggle="tooltip" title="Voir mes bons plans" data-placement="bottom">
							<i class="fa fa-tag"></i>
						</a>

						<a class="btn btn-primary" href="<?php echo home_url();
                            ?>/mes-videos" title="Voir mes vidéos" data-placement="bottom">
							<i class="fa fa-video-camera"></i>
						</a>

						<a class="btn  btn-primary" href="<?php echo home_url();
                            ?>/mes-photos" title="Voir mes photos" data-placement="bottom">
							<i class="fa fa-camera-retro"></i>
						</a>

						<a class="btn  btn-primary" href="<?php echo home_url();
                            ?>/profil" title="" data-placement="bottom">
                    ...
                    ?>
						...
						<a class="btn  btn-primary" href="<?php echo home_url();
                            ?>/login" title="Login">Connexion</a>

					

						<a class="btn  btn-primary" href="<?php echo home_url();
                            ?>/register" title="Login">Créer un compte</a>
					<?php
