...
<ul class="list-product">
	...
	<li class="date-open-store">
		...
		<ul class="">
			<li class=""><?php echo esc_attr( get_the_author_meta( 'lundi_matin_ouverture', $curauth->ID ) );?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'lundi_matin_fermeture', $curauth->ID ) );?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'lundi_aprem_ouverture', $curauth->ID ) );?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'lundi_aprem_fermeture', $curauth->ID ) );?></li>
		</ul>
	</li>
	<?php endif; ?>
	...
	<li class="date-open-store">
		...
		<ul class="">
			<li class=""><?php echo esc_attr( get_the_author_meta( 'mardi_matin_ouverture', $curauth->ID ) );?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'mardi_matin_fermeture', $curauth->ID ) );?></li>
			
			<li class=""><?php echo esc_attr( get_the_author_meta( 'mardi_aprem_ouverture', $curauth->ID ) );?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'mardi_aprem_fermeture', $curauth->ID ) );?></li>
		</ul>
	</li>
	<?php endif; ?>
	...
	<li class="date-open-store">
		...
		<ul class="">
			<li class=""><?php echo esc_attr( get_the_author_meta( 'mercredi_matin_ouverture', $curauth->ID ) ); ?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'mercredi_matin_fermeture', $curauth->ID ) ); ?></li>
			
			<li class=""><?php echo esc_attr( get_the_author_meta( 'mercredi_aprem_ouverture', $curauth->ID ) ); ?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'mercredi_aprem_fermeture', $curauth->ID ) ); ?></li>					
		</ul>
	</li>
	<?php endif; ?>
	...
	<li class="date-open-store">
		...
		<ul class="">
			<li class=""><?php echo esc_attr( get_the_author_meta( 'jeudi_matin_ouverture', $curauth->ID ) );?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'jeudi_matin_fermeture', $curauth->ID ) );?></li>
			
			<li class=""><?php echo esc_attr( get_the_author_meta( 'jeudi_aprem_ouverture', $curauth->ID ) );?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'jeudi_aprem_fermeture', $curauth->ID ) );?></li>
		</ul>
	</li>
	<?php endif; ?>
	...
	<li class="date-open-store">
		...
		<ul class="">
			<li class=""><?php echo esc_attr( get_the_author_meta( 'vendredi_matin_ouverture', $curauth->ID ) );?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'vendredi_matin_fermeture', $curauth->ID ) );?></li>
			
			<li class=""><?php echo esc_attr( get_the_author_meta( 'vendredi_aprem_ouverture', $curauth->ID ) );?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'vendredi_aprem_fermeture', $curauth->ID ) );?></li>
		</ul>
	</li>
	<?php endif; ?>
	...
	<li class="date-open-store">
		...
		<ul class="">
			<li class=""><?php echo esc_attr( get_the_author_meta( 'samedi_matin_ouverture', $curauth->ID ) );?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'samedi_matin_fermeture', $curauth->ID ) );?></li>
			
			<li class=""><?php echo esc_attr( get_the_author_meta( 'samedi_aprem_ouverture', $curauth->ID ) );?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'samedi_aprem_fermeture', $curauth->ID ) );?></li>
		</ul>
	</li>
	<?php endif; ?>
	...
	<li class="date-open-store">
		...
		<ul class="">
			<li class=""><?php echo esc_attr( get_the_author_meta( 'dimanche_matin_ouverture', $curauth->ID ) );?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'dimanche_matin_fermeture', $curauth->ID ) );?></li>
			
			<li class=""><?php echo esc_attr( get_the_author_meta( 'dimanche_aprem_ouverture', $curauth->ID ) );?></li>
			<li class=""><?php echo esc_attr( get_the_author_meta( 'dimanche_aprem_fermeture', $curauth->ID ) );?></li>
		</ul>
	</li>
	<?php endif; ?>
