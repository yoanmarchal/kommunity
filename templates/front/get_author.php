...
function get_Author_Phone($curauth){
	...
	// phone
	if ($tel){ ?>
		<span itemprop="telephone" class="glyphicon glyphicon-earphone"> <?php echo $tel ; ?></span>
	<?php	
	} 
}
...
function get_Author_Url($curauth){
	...
	if ($url){
		...
		<span itemprop="telephone" class="glyphicon glyphicon-link">
			<a href="<?php echo $url ; ?>" title="<?php echo $url ; ?>" itemprop="url">
				<?php echo $url ; ?>
			</a>
		</span>
		<?php	
...
function get_Author_Infos($curauth){
	...
	<ul class="list-unstyled">
		<li><?php get_full_adress_profil($curauth); ?></li>
		<li><?php get_Author_Phone($curauth) ; ?></li>
		<li><?php get_Author_Url($curauth); ?></li>
	</ul>
<?php
}
