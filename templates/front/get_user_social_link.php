...
function get_user_social_link($curauth) {
	...
	<div class="ib">
		...
		<span class="ib" >
			<a href="<?php echo $googlePlusUrl, $GoogleID ;?>?rel=author"><?php echo $googlePlusUrl, $GoogleID ; ?></a>
		</span><br>
		<?php } ?>
		...
		<span class="ib" >
			<a href="<?php echo $facebookUrl, $FacebookID ;?>">  <?php echo $facebookUrl, $FacebookID ; ?></a>
		</span><br>
		<?php } ?>
