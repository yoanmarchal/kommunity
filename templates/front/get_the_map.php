...
function get_the_map()
{
    ...
    if ($rue && $codepostal && $ville && $region) {
		...
		<img src="http://maps.googleapis.com/maps/api/staticmap?center=<?php echo $rue,'+'.$ville,'+'.$codepostal;
        ?>&amp;&markers=<?php echo $rue,'+'.$ville,'+'.$codepostal;
        ?>&amp;zoom=15&amp;size=870x300&amp;maptype=hybrid&amp;sensor=false" alt="placeholder+image">
		<?php 
    } else {
        return false;
    }
