...
{
    add_meta_box('ept_event_date_start', 'Start Date and Time', 'ept_event_date', 'bonplan', 'side', 'default', ['id' => '_start']);
    add_meta_box('ept_event_date_end', 'End Date and Time', 'ept_event_date', 'bonplan', 'side', 'default', ['id' => '_end']);
}
