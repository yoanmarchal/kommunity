...
function date_heure_bp($post){
  ...
  <input type="datetime" name="deb_dat" id="deb_dat" class="mydatepicker" placeholder="01/12/2012" value="<?php echo $debut_date; ?>" style="width:100px;" />
  <input type="text" name="deb_heure" id="" placeholder="08:00" value="<?php echo $debut_heure; ?>" />
  <label>Jusqu'au </label><br>
  <input type="datetime" name="fin_dat" id="fin_dat" class="mydatepicker" placeholder="02/12/2012" value="<?php echo $fin_date; ?>" style="width:100px;"/>
  <input type="text" name="fin_heure" id="" placeholder="18:00" value="<?php echo $fin_heure; ?>" /><br />
