...
function metabox_adresse_fonct($post)
{
    ...
    ?>
  <textarea type="text" name="rue" id="" placeholder="275, rue de toulouse" style="width:256px;" /><?php echo $rue;
    ?></textarea><br />
  <input type="number" name="codepostal" id="" placeholder="87000" value="<?php echo $codepostal;
    ?>" /><br />
  <input type="text" name="ville" id="" placeholder="limoges" value="<?php echo $ville;
    ?>" /><br />
<?php
