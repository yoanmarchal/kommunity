...
//jeudi
 ...
 // vendredi
  ...
  <input type="text" name="lundi_matin_ouverture" id="lundi_matin_ouverture" placeholder="08:00" value="<?php echo $lmo;
    ?>" style="width:50px;" />
  <input type="text" name="lundi_matin_fermeture" id="lundi_matin_fermeture" placeholder="12:00" value="<?php echo $lmf;
    ?>" style="width:50px;" />
  
  <input type="text" name="lundi_aprem_ouverture" id="lundi_aprem_ouverture" placeholder="14:00" value="<?php echo $lao;
    ?>" style="width:50px;" />
  <input type="text" name="lundi_aprem_fermeture" id="lundi_aprem_fermeture" placeholder="18:00" value="<?php echo $laf;
    ?>" style="width:50px;" /><br>
  
  
  <!--mardi-->
  <label class="h-ind">Mardi</label>
  <input type="text" name="mardi_matin_ouverture" id="mardi_matin_ouverture" placeholder="08:00" value="<?php echo $mmo;
    ?>" style="width:50px;" />
  <input type="text" name="mardi_matin_fermeture" id="mardi_matin_fermeture" placeholder="12:00" value="<?php echo $mmf;
    ?>" style="width:50px;" />
  
  <input type="text" name="mardi_aprem_ouverture" id="mardi_aprem_ouverture" placeholder="14:00" value="<?php echo $mao;
    ?>" style="width:50px;" />
  <input type="text" name="mardi_aprem_fermeture" id="mardi_aprem_fermeture" placeholder="18:00" value="<?php echo $maf;
    ?>" style="width:50px;" /><br>
  
  <!--mercredi-->
  <label class="h-ind">Mercredi</label>
  <input type="text" name="mercredi_matin_ouverture" id="mercredi_matin_ouverture" placeholder="08:00" value="<?php echo $mermo;
    ?>" style="width:50px;" />
  <input type="text" name="mercredi_matin_fermeture" id="mercredi_matin_fermeture" placeholder="12:00" value="<?php echo $mermf;
    ?>" style="width:50px;" />
  
  <input type="text" name="mercredi_aprem_ouverture" id="mercredi_aprem_ouverture" placeholder="14:00" value="<?php echo $merao;
    ?>" style="width:50px;" />
  <input type="text" name="mercredi_aprem_fermeture" id="mercredi_aprem_fermeture" placeholder="18:00" value="<?php echo $meraf;
    ?>" style="width:50px;" /><br>
  
  <!--jeudi-->
  <label class="h-ind">Jeudi</label>
  <input type="text" name="jeudi_matin_ouverture" id="jeudi_matin_ouverture" placeholder="08:00" value="<?php echo $jmo;
    ?>" style="width:50px;" />
  <input type="text" name="jeudi_matin_fermeture" id="jeudi_matin_fermeture" placeholder="12:00" value="<?php echo $jmf;
    ?>" style="width:50px;" />
  
  <input type="text" name="jeudi_aprem_ouverture" id="jeudi_aprem_ouverture" placeholder="14:00" value="<?php echo $jao;
    ?>" style="width:50px;" />
  <input type="text" name="jeudi_aprem_fermeture" id="jeudi_aprem_fermeture" placeholder="18:00" value="<?php echo $jaf;
    ?>" style="width:50px;" /><br>
  
  <!--vendredi-->
  <label class="h-ind">Vendredi</label>
  <input type="text" name="vendredi_matin_ouverture" id="vendredi_matin_ouverture" placeholder="08:00" value="<?php echo $vmo;
    ?>" style="width:50px;" />
  <input type="text" name="vendredi_matin_fermeture" id="vendredi_matin_fermeture" placeholder="12:00" value="<?php echo $vmf;
    ?>" style="width:50px;" />
  
  <input type="text" name="vendredi_aprem_ouverture" id="vendredi_aprem_ouverture" placeholder="14:00" value="<?php echo $vao;
    ?>" style="width:50px;" />
  <input type="text" name="vendredi_aprem_fermeture" id="vendredi_aprem_fermeture" placeholder="18:00" value="<?php echo $vaf;
    ?>" style="width:50px;" /><br>
  
   <!--samedi-->
  <label class="h-ind">Samedi</label>
  <input type="text" name="samedi_matin_ouverture" id="samedi_matin_ouverture" placeholder="08:00" value="<?php echo $smo;
    ?>" style="width:50px;" />
  <input type="text" name="samedi_matin_fermeture" id="samedi_matin_fermeture" placeholder="12:00" value="<?php echo $smf;
    ?>" style="width:50px;" />
  
  <input type="text" name="samedi_aprem_ouverture" id="samedi_aprem_ouverture" placeholder="14:00" value="<?php echo $sao;
    ?>" style="width:50px;" />
  <input type="text" name="samedi_aprem_fermeture" id="samedi_aprem_fermeture" placeholder="18:00" value="<?php echo $saf;
    ?>" style="width:50px;" /><br>
  
   <!--dimanche-->
  <label class="h-ind">Dimanche</label>
  <input type="text" name="dimanche_matin_ouverture" id="dimanche_matin_ouverture" placeholder="08:00" value="<?php echo $dmo;
    ?>" style="width:50px;" />
  <input type="text" name="dimanche_matin_fermeture" id="dimanche_matin_fermeture" placeholder="12:00" value="<?php echo $dmf;
    ?>" style="width:50px;" />
  
  <input type="text" name="dimanche_aprem_ouverture" id="dimanche_aprem_ouverture" placeholder="14:00" value="<?php echo $dao;
    ?>" style="width:50px;" />
  <input type="text" name="dimanche_aprem_fermeture" id="dimanche_aprem_fermeture" placeholder="18:00" value="<?php echo $daf;
    ?>" style="width:50px;" /><br>
