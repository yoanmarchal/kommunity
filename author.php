...
-->
	...
	<div class="tab-content">
	  	<div class="tab-pane active" id="home">
			...
			<iframe class="map" width="100%" height="310" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=fr&amp;geocode=&amp;q=<?php echo $rue,'+'.$ville,'+'.$codepostal;
                ?>&amp;aq=0&amp;ie=UTF8&amp;hq=&amp;hnear=<?php echo $rue,'+'.$ville,'+'.$codepostal;
